...
<header>
	...
	<div class="heroe">
		...
		<h1>You Are Not Welcome to CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

		<h2>The small framework with powerful features but not as good as Laravel though.</h2>
